export default function ShoppingCart({className = 'w-8 h-8 cursor-pointer'}) {
    return (
        <svg baseProfile="tiny"viewBox="0 0 24 24" fill="currentColor"height="1em"width="1em" className={className}>
